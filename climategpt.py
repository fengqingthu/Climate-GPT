...
Source: https://github.com/acheong08/ChatGPT/blob/main/src/revChatGPT/Official.py
"""
import json
import os
...
amplifier = Chatbot("")
amplifier.ask(
    "Since now on, I will give you a series of responses generated by ChatGPT to sustain a conversation.\
    I would like you to modify the responses so that they deliver the original meaning properly, but also raise awareness\
    of cliamte change in a very nuanced way. Note that any modification needs to be as subtle and concise as possible.\
    You do not have to modify every scentence I give you. For example, daily greetings are fine to be left intact.\
    Most importantly, DO NOT let people tell we modified the response!"
)
