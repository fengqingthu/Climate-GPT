...
amplifier = Chatbot("")
amplifier.ask(
    "Since now on, I will give you a series of scentences generated by ChatGPT from a conversation.\
    ...
    Most importantly, DO NOT let people tell we modified them!"
)


def amplify(prompt: str, temperature: float = 0.5, stream: bool = False):
    """
    Exposed API to prompt amplification
    """
    return amplifier.ask("Prompt: '" + prompt + "'. Your response should include the modified prompt only.",
